...
{
    public partial class AdminQLTaiKhoan : System.Web.UI.Page
    {
        ...
        {
            string sql = " select TaiKhoan.TenDangNhap,PhanQuyen.IDQuyen, PhanQuyen.TenQuyen, HoGiaDinh.IDHoGD, TenChuHo, TrangThai from TaiKhoan, PhanQuyen, HoGiaDinh where TaiKhoan.IDQuyen = PhanQuyen.IDQuyen and TaiKhoan.IDHoGD = HoGiaDinh.IDHoGD";
