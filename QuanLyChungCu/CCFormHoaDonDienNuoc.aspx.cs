...
{
    public partial class CCFormHoaDonDienNuoc : System.Web.UI.Page
    {
        ...
        private void load()
        {
            ...
            if (username != "")
            {
                string sql = "SELECT HoaDonDienNuoc.IDHoaDon, HoaDonDienNuoc.LoaiHD, HoGiaDinh.TenChuHo, HoaDonDienNuoc.TieuThu,HoaDonDienNuoc.NgLap, HoaDonDienNuoc.GiaTieuThu, HoaDonDienNuoc.TinhTrang, HoaDonDienNuoc.HinhAnh, (HoaDonDienNuoc.TieuThu*HoaDonDienNuoc.GiaTieuThu) As TongTien " + 
        ...
        protected void btn_upload_Click(object sender, EventArgs e)
        {
            ...
            if (file.HasFile)
            {
                ...
                string sql = " update HoaDonDienNuoc set HinhAnh='" + upload + "', TinhTrang=N'"+trangthai+"' where IDHoaDon='" + idhoadon + "' ";
        ...
        protected void btn_bill_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("CCFormHoaDonBill.aspx?idhoadon=" + idhoadon);
        }
    }
}